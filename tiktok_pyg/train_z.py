...
def save_results(data, filepath="tiktok_pyg/results_z.csv"):
...
def main():
    ...
    models_dir = "tiktok_pyg/trained_models/"
    ...
    train_hd_filename = f"train_hd_{year}_{month}_{perc}_tiktok.pt"
    ...
    # Checkpoint loading
    if latest_epoch > 0:
        checkpoint_path = f"tiktok_pyg/trained_models/model_{model_name}_{year}_{month}_{perc}_{latest_epoch}.pth"
