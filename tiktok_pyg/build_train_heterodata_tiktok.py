...
def main():
    ...
    full_path = path.join(data_folder, f"full_hd_{percentile}_tiktok.pt")
    ...
    if cut_year is not None:
        ...
        result_path = path.join(data_folder, f"train_hd_{cut_year}_{cut_month}_{percentile}_tiktok.pt")
        collab_with_path = path.join(data_folder, f"collab_with_{cut_year}_{cut_month}_{percentile}_tiktok.pt")
