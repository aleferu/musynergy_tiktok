...
def get_params_from_csv(model_name, year, perc, filepath="intiktok_pyg/results_z.csv"):
    try:
...
def main():
    ...
    if best_threshold is None:
        print("Error: Could not find training parameters (threshold, mean, std) in intiktok_pyg/results_z.csv")
        return
